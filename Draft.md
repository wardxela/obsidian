...
- Начнем с того, что эти теги могут быть использованы **многократно** на странице вопреки общему мнению. Основная цель этих тегов - выделить **мета-информацию** в рамках некоторой секции - информацию, которая дополнительно раскрывает основную сущность, но не является обязательной. Основное отличие `<header>` от `<footer>` в том, что первый выделяет **наиболее** важную информацию. 
...
**Пару слов о подходах к продвинутой семантической верстке**
